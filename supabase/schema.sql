...
create index if not exists admin_activity_vendor_idx on public.admin_activity ("vendorId");

alter table public.admin_activity enable row level security;

drop policy if exists "admin_activity_all" on public.admin_activity;
create policy "admin_activity_all"
